/* Copyright 2005-2006 Google. To use maps on your own site, visit http://www.google.com/apis/maps/. */ (function()
{
	...
	function sg(a,b,c,d)
	{
		...
		tg(a);
//		tg(a,b,c);
		document.write('<style type="text/css" media="screen">.gmnoscreen { display:none } </style>');
		document.write('<style type="text/css" media="print">.'+Sc+" { display:none } </style>")
	}
	...
	Wc.prototype.gm=function(a,b)
	{
		if(wh(b))
		{
			document.cookie="khcookie="+a+";domain=."+b+";path=/kh;"
		}
	...
	w.prototype.pf=function()
	{
		...
		return { divPixel:b,position:c,shadowPosition:d }
	}
	...
	ma.prototype.Ei=function(a,b,c)
	{
		...
		if(j(d)>0)
		{
			...
			var Z="http://kolia.pp.ru/maps/mld.php?width="+K+"&height="+M+"&path="+d+"&color="+n+","+q+","+r+","+C+"&weight="+this.K;
			...
			e++)
			{
				...
				if(u.type==1)
				{
					...
					if(n)
					{
						...
						i.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+h[e].image+"', sizingMethod='image');"
					}
